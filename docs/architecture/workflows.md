...
> **🎯 Target Audience**: DevOps engineers, platform teams, CI/CD implementers  
> **📊 Complexity**: ⭐⭐⭐ Advanced  
> **📋 Prerequisites**: GitHub Actions experience, workflow troubleshooting  
> **⏱️ Reading Time**: 15-20 minutes

## Overview

This document provides comprehensive reference documentation for all GitHub Actions workflows in the repository. It consolidates workflow-specific implementation details, configuration management, troubleshooting guides, and best practices.

> **📋 Note**: This document consolidates content from `.github/workflows/README.md` for centralized documentation management in the `docs/` directory.
...
- **CI/CD Architecture**: [cicd.md](cicd.md) - Comprehensive architectural overview
...
*This documentation consolidates workflow implementation details and is maintained alongside the workflow files in `.github/workflows/`.*